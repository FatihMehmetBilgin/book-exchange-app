...
import 'package:book_exchange/consts.dart';
...
import 'package:book_exchange/services/media_service.dart';
import 'package:book_exchange/services/navigation_service.dart';
import 'package:book_exchange/services/storage_service.dart';
import 'package:book_exchange/widgets/custom_form_field.dart';
  ...
  Widget _headerText() {
    return SizedBox(
      ...
      child: const Column(
        ...
        children: [
          Text(
            "Share Your Books, Discover New Stories!",
            style: TextStyle(
              fontSize: 20,
          ...
          Text(
            "Join us to expand your library and connect with fellow book lovers!",
            style: TextStyle(
              fontSize: 14,
